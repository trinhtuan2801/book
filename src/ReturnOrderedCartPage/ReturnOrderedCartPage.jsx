...
import ReturnOrderedCartStatusBar from './ReturneOrderedCartStatusBar';
const ReturnOrderedCartPage = () => {
  ...
  return (
    ...
    >
      <Box
        ...
        width='100%'
      >
        <ReturnOrderedCartStatusBar />
        <Box marginTop={2} />

        <InfinityScroller
          url={`${BASE_API}/return-ordered-carts`}
          arrayKey='carts'
          params={{
            limit: 10,
            status
...
export default ReturnOrderedCartPage;